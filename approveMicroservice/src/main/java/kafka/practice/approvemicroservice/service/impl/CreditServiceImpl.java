...
public class CreditServiceImpl {
    ...
    @Autowired
    public CreditServiceImpl(CreditRepository creditRepository, ReactiveKafkaConsumerTemplate<String, Credit> kafkaConsumer, BorrowerServiceImpl borrowerService, ReactiveKafkaProducerTemplate<String, CreditCheckEvent> kafkaTemplate) {
