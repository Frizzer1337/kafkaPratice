...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, Credit> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Credit>
    kafkaListenerContainerFactory() {

        ConcurrentKafkaListenerContainerFactory<String, Credit> factory =
